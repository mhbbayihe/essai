...
const Verification: React.FC = () => {
  ...
  const onSubmit = (data: FormData) => {
    ...
    const concatenatedResult = data.inputs.join('');
    console.log("Résultat concaténé :", concatenatedResult);
  };
        ...
        <div>
          <div className="flex items-center justify-center rounded-2xl bg-white shadow-2xl">
            ...
            <div className="max-w-md w-full md:border-l-2 px-7 py-9">
              <h2 className="text-gray-800 text-4xl font-bold">Confirmer votre identité</h2>
              <p className="text-gray-400 text-1xl mt-2 leading-relaxed">Entrer le code qui vous a été envoyé dans le mail.</p>
              <hr className="mt-3" />
